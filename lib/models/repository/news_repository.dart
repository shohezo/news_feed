...
class NewsRepository {
  ...
  static const API_KEY = "ec5c8b7350b646a7bb14190962b6471e";
  ...
  Future<List<Article>> insertAndReadFromDB(responseBody) async {
    ...
    //TODO webから取得した記事リスト（Dartのモデルクラス:Article）をDBのテーブルクラス（ArticleRecord）に変換してDB登録
    final articleRecords =
        await dao.insertAndReadNewsFromDB(articles.toArticleRecords(articles));

    //TODO DBから取得したデータをモデルクラスに再変換して渡す
